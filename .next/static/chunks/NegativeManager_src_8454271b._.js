...
"[project]/NegativeManager/src/components/ui/switch.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Switch(param) {
    let { className, ...props } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$3_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$node_modules$2f2e$pnpm$2f40$radix$2d$ui$2b$react$2d$switch$40$1$2e$2$2e$6_$40$types$2b$react$2d$dom$40$19$2e$1$2e$9_$40$types$2b$react$40$19$2e$1$2e$13_$5f40$types$2b$react_d51a4667fcd0972f77309957b0704a35$2f$node_modules$2f40$radix$2d$ui$2f$react$2d$switch$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Root"], {
        "data-slot": "switch",
...
"[project]/NegativeManager/src/utils/constants.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/NegativeManager/src/app/settings/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$src$2f$components$2f$ui$2f$switch$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/NegativeManager/src/components/ui/switch.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/NegativeManager/src/utils/constants.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function SettingsPage() {
        ...
        "SettingsPage.useEffect": ()=>{
            const loadSettings = {
                "SettingsPage.useEffect.loadSettings": ()=>{
                    try {
                        const savedSettings = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEYS"].SETTINGS);
                        if (savedSettings) {
                            const parsed = JSON.parse(savedSettings);
                            setSettings({
                                "SettingsPage.useEffect.loadSettings": (prev)=>({
                                        ...prev,
                                        ...parsed
                                    })
                            }["SettingsPage.useEffect.loadSettings"]);
    ...
    const saveSettings = async ()=>{
        ...
        try {
            localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEYS"].SETTINGS, JSON.stringify(settings));
            setSaveStatus('saved');
    ...
    const testConnection = async ()=>{
        ...
        try {
            ...
            const response = await fetch("".concat(settings.googleSheetsUrl, "?action=search-terms&page=1&pageSize=1"));
            if (response.ok) {
                ...
                if (data.success) {
                    ...
                    setTestStatus('error');
                    setTestMessage("API Error: ".concat(data.error || 'Unknown error'));
                }
            } else {
                setTestStatus('error');
                setTestMessage("HTTP Error: ".concat(response.status, " ").concat(response.statusText));
            }
        } catch (error) {
            setTestStatus('error');
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$3_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$3_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$src$2f$components$2f$ui$2f$switch$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Switch"], {
                                                        id: "auto-refresh",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$3_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$3_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                                variant: "outline",
                                                                onClick: ()=>{
                                                                    localStorage.removeItem(__TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEYS"].CACHE);
                                                                    localStorage.removeItem(__TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEYS"].FILTERS);
                                                                    localStorage.removeItem(__TURBOPACK__imported__module__$5b$project$5d2f$NegativeManager$2f$src$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEYS"].TABLE_STATE);
...
_s(SettingsPage, "P5TOQaHYR6fN1s840St20TbyIXk=");
_c = SettingsPage;
var _c;
...
//# sourceMappingURL=NegativeManager_src_8454271b._.js.map